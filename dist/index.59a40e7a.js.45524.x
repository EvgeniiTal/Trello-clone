...
function buildTemplateCard(task) {
    return `<div class="card mt-2" data-id="${task.id}" draggable="true">
    <div class="card-body">
...
toDoColumnElement.addEventListener("dragstart", dragStart);
toDoColumnElement.addEventListener("dragend", dragEnd);
if (getData("tasks")) {
...
},{"@popperjs/core":"7unqC","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["gl6Mp","8lRBv"], "8lRBv", "parcelRequire656e")
