...
parcelHelpers.export(exports, "modalCreateNewTask", ()=>modalCreateNewTask);
parcelHelpers.export(exports, "tasks", ()=>tasks);
parcelHelpers.export(exports, "taskTitle", ()=>taskTitle);
parcelHelpers.export(exports, "taskDescription", ()=>taskDescription);
parcelHelpers.export(exports, "taskUserSelect", ()=>taskUserSelect);
parcelHelpers.export(exports, "toDoColumnElement", ()=>toDoColumnElement);
parcelHelpers.export(exports, "inProgressColumnElement", ()=>inProgressColumnElement);
parcelHelpers.export(exports, "doneColumnElement", ()=>doneColumnElement);
parcelHelpers.export(exports, "id", ()=>id);
parcelHelpers.export(exports, "modalEditTask", ()=>modalEditTask);
parcelHelpers.export(exports, "editTaskTitle", ()=>editTaskTitle);
parcelHelpers.export(exports, "editTaskUserSelect", ()=>editTaskUserSelect);
parcelHelpers.export(exports, "editTaskDescription", ()=>editTaskDescription);
parcelHelpers.export(exports, "columns", ()=>columns);
parcelHelpers.export(exports, "modalNoticeDeleteAllTasks", ()=>modalNoticeDeleteAllTasks);
parcelHelpers.export(exports, "modalNoticeMoreInProgressTasks", ()=>modalNoticeMoreInProgressTasks);
parcelHelpers.export(exports, "handleEditTask", ()=>handleEditTask);
...
const modalCreateNewTask = new _bootstrap.Modal(modalCreateNewTaskElement, {
    keyboard: false,
    backdrop: "static"
});
const modalEditTaskElement = $("#modalEditTask");
const modalEditTask = new _bootstrap.Modal(modalEditTaskElement, {
    keyboard: false
});
const modalNoticeDeleteAllTasksElement = $("#modalNoticeDeleteAllTasks");
const modalNoticeDeleteAllTasks = new _bootstrap.Modal(modalNoticeDeleteAllTasksElement, {
    keyboard: false
});
const modalNoticeMoreInProgressTasksElement = $("#modalNoticeMoreInProgressTasks");
const modalNoticeMoreInProgressTasks = new _bootstrap.Modal(modalNoticeMoreInProgressTasksElement, {
    keyboard: false
});
...
let id;
let users = [];
if ((0, _localStorageJs.getData)("tasks")) {
    tasks = JSON.parse((0, _localStorageJs.getData)("tasks"));
    (0, _renderJs.render)(tasks);
}
...
function handleEditTask(event) {
    ...
    if (target.id === "editTaskButton") {
        ...
        const { title, description, user } = tasks[index];
...
createTaskButton.addEventListener("click", (0, _handlersJs.showModal));
saveTaskButton.addEventListener("click", (0, _handlersJs.saveTask));
cancelTaskButton.addEventListener("click", ()=>{
    modalCreateNewTask.hide();
});
saveEditsButton.addEventListener("click", (0, _handlersJs.saveEdits));
cancelEditsButton.addEventListener("click", ()=>{
    modalEditTask.hide();
});
completeDeleteAllTasks.addEventListener("click", (0, _handlersJs.deleteAllTasks));
...
(0, _dragAndDropJs.dragAndDrop)();

},{"@popperjs/core":"7unqC","bootstrap":"h36JB","./handlers.js":"jlk9X","./localStorage.js":"45bAM","./render.js":"6Nkx6","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./dragAndDrop.js":"eJeUA"}],"7unqC":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@popperjs/core":"7unqC","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jlk9X":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
parcelHelpers.export(exports, "saveEdits", ()=>saveEdits);
...
function showModal() {
    (0, _appJs.modalCreateNewTask).show();
}
// обработчик создания новой задачи
function saveTask() {
    const task = new (0, _appJs.Task)((0, _appJs.taskTitle).value, (0, _appJs.taskDescription).value, (0, _appJs.taskUserSelect).value);
    (0, _appJs.tasks).push(task);
    (0, _appJs.taskTitle).value = "";
    (0, _appJs.taskDescription).value = "";
    (0, _appJs.taskUserSelect).value = "";
    (0, _appJs.modalCreateNewTask).hide();
    (0, _appJs.toDoColumnElement).insertAdjacentHTML("beforeend", (0, _templatesJs.buildTemplateCard)(task));
    (0, _localStorageJs.setData)("tasks", (0, _appJs.tasks));
}
...
function handleDeleteTask(event) {
    ...
    if (target.id === "deleteTaskButton") {
        ...
        const index = (0, _appJs.tasks).findIndex((task)=>task.id === Number(id));
        (0, _appJs.tasks).splice(index, 1);
        (0, _localStorageJs.setData)("tasks", (0, _appJs.tasks));
    }
}
// обработчик сохранения изменений
function saveEdits() {
    const index = (0, _appJs.tasks).findIndex((task)=>task.id === Number((0, _appJs.id)));
    const task = (0, _appJs.tasks)[index];
    task.title = (0, _appJs.editTaskTitle).value;
    task.description = (0, _appJs.editTaskDescription).value;
    task.user = (0, _appJs.editTaskUserSelect).value;
    (0, _renderJs.render)((0, _appJs.tasks));
    (0, _localStorageJs.setData)("tasks", (0, _appJs.tasks));
    (0, _appJs.modalEditTask).hide();
}
// обработчик удаления всех задач
function deleteAllTasks() {
    const doneTasks = (0, _appJs.tasks).filter((task)=>task.status === "done");
    doneTasks.forEach((task)=>{
        const index = (0, _appJs.tasks).findIndex((t)=>t.id === task.id);
        (0, _appJs.tasks).splice(index, 1);
    });
    (0, _appJs.columns)[2].innerHTML = "";
    (0, _appJs.modalNoticeDeleteAllTasks).hide();
    (0, _localStorageJs.setData)("tasks", (0, _appJs.tasks));
}

},{"./app.js":"8lRBv","./localStorage.js":"45bAM","./templates.js":"18mfC","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./render.js":"6Nkx6","@popperjs/core":"7unqC","bootstrap":"h36JB"}],"45bAM":[function(require,module,exports) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"18mfC":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "buildTemplateCard", ()=>buildTemplateCard);
var _appJs = require("./app.js");
// функция для создания шаблона карточки
function buildTemplateCard({ id, title, description, user }) {
...
},{"./app.js":"8lRBv","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"6Nkx6":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
function render(renderData) {
    ...
    renderData.forEach((task)=>{
        if (task.status == "todo") {
            html += (0, _templatesJs.buildTemplateCard)(task);
            return (0, _appJs.toDoColumnElement).innerHTML = html;
        } else if (task.status == "inprogress") {
            html += (0, _templatesJs.buildTemplateCard)(task);
            return (0, _appJs.inProgressColumnElement).innerHTML = html;
        } else if (task.status == "done") {
            html += (0, _templatesJs.buildTemplateCard)(task);
            return (0, _appJs.doneColumnElement).innerHTML = html;
        }
    });
}

},{"./app.js":"8lRBv","./templates.js":"18mfC","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"eJeUA":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
function dragAndDrop() {
    ...
    (0, _appJs.columns).forEach((item)=>{
        ...
        item.addEventListener("drop", function(event) {
            event.preventDefault();
            const { status: column } = item.dataset;
            const index = (0, _appJs.tasks).findIndex((task)=>task.id === Number(id));
            const task = (0, _appJs.tasks)[index];
            task.status = column;
            const inProgressTasks = (0, _appJs.tasks).filter((task)=>task.status === "inprogress");
            if (column === "inprogress" && inProgressTasks.length > 6) {
                (0, _appJs.modalNoticeMoreInProgressTasks).show();
                return;
            } else this.append(card);
            (0, _localStorageJs.setData)("tasks", (0, _appJs.tasks));
        });
        item.addEventListener("click", (0, _handlersJs.handleDeleteTask));
        item.addEventListener("click", (0, _appJs.handleEditTask));
    });
}

},{"./app.js":"8lRBv","./localStorage.js":"45bAM","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./handlers.js":"jlk9X"}]},["gl6Mp","8lRBv"], "8lRBv", "parcelRequire656e")
